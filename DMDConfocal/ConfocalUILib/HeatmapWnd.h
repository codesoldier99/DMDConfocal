...
class HeatmapWnd :public CWnd, public HCorePanel, public HVideoRender
{
public:
  HeatmapWnd(void);
  ~HeatmapWnd(void);
  ...
  // 获取线段的位置
  void GetLinePosition(CPoint& pt1, CPoint& pt2);
protected:
  ...
  CPoint Map2Image(const CPoint& pt);
  //以下gdi
